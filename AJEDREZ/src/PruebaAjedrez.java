...
public class PruebaAjedrez {
    ...
    public static void imprimirMenu() {
        System.out.println("*******************************************************************");
        System.out.println("*                                                                 *");
        System.out.println("*               \u001B[38;5;117m♛  AJEDREZ; LA REINA Y SUS PEONES ♛\u001B[0m              *");
        System.out.println("*                                                                 *");
        System.out.println("*******************************************************************");
        System.out.println();
        System.out.println("|-----------------------------------------------------------------|");
        System.out.println("|                        \u001B[38;5;117m\u001B[4m¿Cómo funciona?\u001B[38;5;117m\u001B[0m                          |");
        System.out.println("|                                                                 |");
        ...
        System.out.println();
        System.out.println("*******************************************************************");
        System.out.println("*                ¡Esperamos que disfrutes, \u001B[38;5;117mreina\u001B[0m!                 *");
        System.out.println("*******************************************************************");
        System.out.println();
        System.out.println();
    }
    ...
    public static boolean finaljuego() {
        ...
        do {
            ...
            if (opcion == 'S') {
                ...
                System.out.println("******************************************************");
                System.out.println("*              ¡Gracias por jugar, \u001B[38;5;117mreina\u001B[0m!            *");
                System.out.println("******************************************************");
                opcionValida = true;
